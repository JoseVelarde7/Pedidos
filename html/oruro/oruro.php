  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" align="center">
        ...
        <h1 class="modal-title">LISTA DE CLIENTES ORURO</h1>
      </div>
      <div class="modal-body">
        <div><a href="#" class="btn btn-success" id="reloadtable">Mostrar/Actualizar</a></div>
    	<table id="table" data-search="true" data-smart-display="true" data-height="430"></table>
      </div>											
		...
		<script>
			...
			$(document).ready(function(){
				...
				$('#tab-cocha').on('click',function(e){
					e.preventDefault();
					$.getJSON("../../php/sucursal.php", { ope: "prod-oruro"})
				...
				$('#busStock').click(function(e){
					...
					$.getJSON("../../php/sucursal.php",{ope: "getStock2",nombre:nombre})
				  .done(function(resp) {
				...
				$('#addStock').click(function(e){
					...
					$.getJSON("../../php/sucursal.php",{ope: "agregarStock2",codigo:codigo,stock:nstock})
				  .done(function(resp) {
				  	console.log(resp);
    		...
    		var n1a=0;
				$.getJSON("../../php/sucursal.php",{ope: "listaManteca2"})
				  .done(function(resp) {
				  	$('.pmanteca').typeahead({
						  hint: true,
						  highlight: true,
